...
本仓库主文件为 `course-management-system.zip`：下载解压后即可本地运行（内含 course-client / course-server / docs / 设计文档 v2.3）。
...
解压 `course-management-system.zip`，得到大致结构：
...
| 文档 | 说明 |
|------|------|
| 设计文档 v2.3 | UI / 架构 / API / 库表 |
| docs/ | PRD、权限矩阵、流程、UAT、数据字典、Changelog、演示脚本、Design Tokens |

## 常用说明

- 首次运行务必先 `db push` 再 `db:seed`，否则没有演示数据
- 学习进度、评价样例已在 seed 中写入
- 课程封面为蓝系主题四档（sky / blue / deep / navy）
